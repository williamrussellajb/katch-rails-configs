...
public class LanderPage extends BasePageObject { // Try to use the methods from base page object.
	...
	public void clickFooterAboutButton() {
		zc.clickFooterAboutLink();
	}

	public void clickFooterContactButton() {
		zc.clickFooterContactLink();
	}

	public void clickFooterShopButton() {
		zc.clickFooterShopLink();
	}

	public void clickFooterPrivacyPolicyLink() {
		zc.clickFooterPrivacyPolicyMobileSEM();
	}

	public void clickFooterTermsLink() {
		zc.clickFooterTermsMobileSEM();
	}
